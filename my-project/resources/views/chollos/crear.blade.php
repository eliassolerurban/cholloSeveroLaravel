...
<form action="{{ route('crear') }}" method="POST">
  @csrf
  <input type="text" name="título" placeholder="Título del chollo" class="form-control mb-2" required autofocus>
  ...
  {{-- <input type="number" name="puntuación" placeholder="Puntuación del chollo" class="form-control mb-2" required> --}}
